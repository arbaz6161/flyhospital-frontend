<template>
    ...
    <main class="container my-5">
        ...
        <div class="listings-header mb-4">
            <h2>{{ name }}</h2>
            <p class="text-muted">The FlyHospitals is based on data science algorithms, providing a trusted, transparent, and objective comparison. It takes into account patient demand, review scores (both positive and negative), the frequency of updates to procedure options and prices, response speed, and clinic certifications.</p>
        </div>
        ...
        <div class="text-center mt-5">
            <p class="text-muted">You've viewed 5 of {{ subprocedures.length }} hospitals</p>
