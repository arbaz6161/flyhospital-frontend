...
<form @submit.prevent="handleSubmit">
    <div class="row g-4">
      <div class="col-md-6">
        ...
        <input v-model="form.name" type="text" class="form-control" id="name" placeholder="Alex White">
      </div>

      <div class="col-md-6">
        <label for="email" class="form-label">Email</label>
        <input v-model="form.email" type="email" class="form-control" id="email" placeholder="example@gmail.com">
      </div>
      ...
      <div class="col-md-6">
        ...
        <select v-model="form.contact_category_id" class="form-select" id="category" name="category">
